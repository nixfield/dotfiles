...
const char *spcmd2[] = {
    TERMINAL, "-n",    "spcalc", "-f", "JetBrainsMono Nerd Font Bandit:size=14",
    "-g",     "60x20", "-e",     "bc", "-lq",
    NULL};
const char *spcmd6[] = {TERMINAL, "-n", "spranger", "-g",
                        "120x32", "-e", "ranger",   NULL};
const char *spcmd3[] = {TERMINAL, "-n", "spfm",  "-g",
                        "120x32", "-e", "lfrun", NULL};
const char *spcmd4[] = {TERMINAL, "-n", "spmusic", "-g",
                        "100x25", "-e", "ncmpcpp", NULL};
const char *spcmd5[] = {TERMINAL, "-n", "spcalcurse", "-g",
                        "100x25", "-e", "calcurse",   NULL};
static Sp scratchpads[] = {
    /* name          cmd  */
    {"spterm", spcmd1},  {"spcalc", spcmd2},     {"spfm", spcmd3},
    {"spmusic", spcmd4}, {"spcalcurse", spcmd5}, {"spranger", spcmd6},
};
...
// button 1 = klik kiri, 2 = middle, 3 = klik kanan. event mask 0 = doesnt have
