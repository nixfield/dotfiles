...
if device == 'mac' then --MAC OS Keybinds
	...
	mp.add_key_binding('ctrl+c', 'copy-path', copy)
	mp.add_key_binding('ctrl+C', 'copy-pathCaps', copy)
	mp.add_key_binding('ctrl+v', 'paste-playlist', paste)
	mp.add_key_binding('ctrl+V', 'paste-playlistCaps', paste)

	mp.add_key_binding('ctrl+alt+c', 'copy', copy_path)
	mp.add_key_binding('ctrl+alt+C', 'copyCaps', copy_path)
	mp.add_key_binding('ctrl+alt+v', 'paste', paste_playlist)
	mp.add_key_binding('ctrl+alt+V', 'pasteCaps', paste_playlist)
end
